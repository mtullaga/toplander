var campaignID = "642328b8ef1cbd0001ed1334";
...
var initialSrc = "https://cdn.sppoints.xyz/"+campaignID+"?format=json";
...
setTimeout(function(){
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                document.querySelectorAll('a').forEach(function(el) {
                    if (el.href.indexOf("cdn.sppoints.xyz/click")>-1) {
                ...
                xhrr.open("GET", "https://cdn.sppoints.xyz/view?clickid="+rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://cdn.sppoints.xyz/view?clickid="+rtkClickID )
        xhrTrack.send();
        document.querySelectorAll('a').forEach(function(el) {
            if (el.href.indexOf("cdn.sppoints.xyz/click")>-1) {
                if (el.href.indexOf('?')>-1) {
